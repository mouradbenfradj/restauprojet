...
<div class="art-sheet clearfix">
        ...
        <?php include_once('menug.php'); ?>
                ...
                <tr>
                    ...
                    <td style="width: 50%; "><input type="text" name="titre"></td>
               	</tr>
                <tr>
                	<td style="width: 50%; ">contenu</td>
                    <td style="width: 50%; "><input type="text" name="contenu"></td>
               	</tr>
                <tr>
                	<td style="width: 50%; ">datedeb</td>
                    <td style="width: 50%; "><input type="date" name="datedeb"></td>
               	</tr>
                <tr>
                	<td style="width: 50%; ">datefintd>
                    <td style="width: 50%; "><input type="date" name="datefin"></td>
               	</tr>
                <tr>
                	<td style="width: 50%; ">photo</td>
                    <td style="width: 50%; "><input type="file" name="photo"></td>
               	</tr>
                <tr>
				...
				$evennement->setPhoto($_FILES['photo']['name']);
				$evennement->addEvennement();
				?><p>
</p></div>
<?php } ?>
