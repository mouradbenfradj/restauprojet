...
<div class="art-sheet clearfix">
        ...
        <?php include_once('menug.php'); ?>
                ...
                <?php if(!isset($_POST['titre'])){ $menu->setId($_POST['mod']); $menu->findMenu();?>
    			<form enctype="multipart/form-data" action="" method="post">
                <table class="art-article" style="width: 100%; "><tbody>
                <tr>
                	<td style="width: 50%; ">titre</td>
                    <td style="width: 50%; "><input type="hidden" name="id" value="<?php echo $_POST['mod']; ?>"><input type="text" name="titre" value="<?php echo $menu->getTitre(); ?>"></td>
               	</tr>
                <tr>
                	<td style="width: 50%; ">contenu</td>
                    <td style="width: 50%; "><input type="text" name="contenu" value="<?php echo $menu->getContenu(); ?>"></td>
               	</tr>
                <tr>
                	<td style="width: 50%; ">description</td>
                    <td style="width: 50%; "><input type="text" name="description" value="<?php echo $menu->getDescription(); ?>"></td>
               	</tr>
                <tr>
                	<td style="width: 50%; ">prix</td>
                    <td style="width: 50%; "><input type="text" name="prix" value="<?php echo $menu->getPrix(); ?>"></td>
               	</tr>
                <tr>
                	<td style="width: 50%; ">photo</td>
                    <td style="width: 50%; "><input type="hidden" name="anphoto" value="<?php echo $menu->getPhoto(); ?>"><input type="file" name="photo"></td>
               	</tr>
                <tr>
