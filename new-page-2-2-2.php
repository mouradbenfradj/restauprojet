...
if(isset($_POST['sup'])){
	$evennement->setId($_POST['sup']);
	$evennement->setPhoto($_POST['nomph']);
	$evennement->supEvennement();
}
?>
<!DOCTYPE html>
